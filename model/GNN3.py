...
class GNN3(torch.nn.Module):
    def __init__(self, feature_size, edge_feature_size, embedding_size=256):
        ...
        # Edge-aware GAT + TopKPooling blocks (passes bond features)
